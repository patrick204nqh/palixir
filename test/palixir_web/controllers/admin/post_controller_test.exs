defmodule PalixirWeb.Admin.PostControllerTest do
  use PalixirWeb.ConnCase

  alias Palixir.Blog

  @create_attrs %{body: "some body", published: true, published_at: ~N[2022-07-09 03:43:00], title: "some title", views: 42}
  @update_attrs %{body: "some updated body", published: false, published_at: ~N[2022-07-10 03:43:00], title: "some updated title", views: 43}
